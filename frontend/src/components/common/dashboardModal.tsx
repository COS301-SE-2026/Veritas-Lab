    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose}>
            <form onSubmit={handleSubmit}>
                ...
                <Input id="caseTitle" type="text" value={title} onChange={(value) => setTitle(value)} placeholder="Enter case title" className="border border-gray-300 rounded-lg py-2 px-4 focus:outline-none focus:ring-2 focus:ring-[#3DBF79] mb-4 w-full text-[16px] text-[#231F20]" required />
                <Label text="Case Description" htmlFor="caseDescription" className="mb-2 text-[16px] text-[#231F20]" />
                <Input id="caseDescription" type="text" value={description} onChange={(value) => setDescription(value)} placeholder="Enter case description" className="border border-gray-300 rounded-lg py-10 px-4 focus:outline-none focus:ring-2 focus:ring-[#3DBF79] mb-4 w-full text-[16px] text-[#231F20]" required />
