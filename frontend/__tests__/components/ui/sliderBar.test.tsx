...
describe('SliderBar', () => {
    ...
    it('renders filters and respects defaultFilter', () => {
        ...
        expect(openButton).toHaveClass('bg-[var(--color-secondary)]');
        expect(closedButton).not.toHaveClass('bg-[var(--color-secondary)]');
    });
    //update test
    it('updates active filter and calls onChange', () => {
        ...
        expect(closedButton).toHaveClass('bg-[var(--color-secondary)]');
    });
});
